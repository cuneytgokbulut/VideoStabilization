...
public abstract class ImageProcessor implements Cloneable {
	...
	*/
	...
	public abstract void toLeft(int angle);
	public abstract void fromTop(int angle);
	public abstract void applyParameters(double angle,int top, int left, double scale);
